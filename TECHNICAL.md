...
- **100 cases:** 40 garment-classification (GU), 30 outfit-ranking (OR), 20 occasion-distinction (OC), 10 weather/context (WX). Case files are written neutrally — no engine rules, thresholds, predictions, Amodka taxonomy mappings, or developer conclusions — so an independent Nigerian/African fashion reviewer can label them without contamination.
